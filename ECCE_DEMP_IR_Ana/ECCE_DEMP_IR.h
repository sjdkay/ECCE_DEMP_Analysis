...
//  -*- C++ -*-.
#ifndef ECCE_DEMP_IR_ANA_H
#define ECCE_DEMP_IR_ANA_H
...
class ECCE_DEMP_IR : public SubsysReco
{
 public:

  ECCE_DEMP_IR(const std::string &name = "ECCE_DEMP_IR", const std::string &fname = "MyNtuple.root");

  virtual ~ECCE_DEMP_IR();
 ...
 protected:
  ...
  TH1F* h1_eTrack_p[8];
  TH1F* h1_eTrack_E[8];
  TH1F* h1_eTrack_Theta[8];
  TH1F* h1_eTrack_Phi[8];
  TH2F* h2_eTrack_ThetaPhi[8];
  TH2F* h2_eTrack_pTheta[8];

  TH1F* h1_piTrack_px[8];
  TH1F* h1_piTrack_py[8];
  TH1F* h1_piTrack_pz[8];
  TH1F* h1_piTrack_p[8];
  TH1F* h1_piTrack_E[8];
  TH1F* h1_piTrack_Theta[8];
  TH1F* h1_piTrack_Phi[8];
  TH2F* h2_piTrack_ThetaPhi[8];
  TH2F* h2_piTrack_pTheta[8];
  ...
  TH1F* h1_nTrack_p[8];
  TH1F* h1_nTrack_E[8];
  TH1F* h1_nTrack_Theta[8];
  TH1F* h1_nTrack_Phi[8];
  TH2F* h2_nTrack_ThetaPhi[8];
  TH2F* h2_nTrack_pTheta[8];

  TH1F* h1_e_enCoin_px[8];
  TH1F* h1_e_enCoin_py[8];
  TH1F* h1_e_enCoin_pz[8];
  TH1F* h1_e_enCoin_p[8];
  TH1F* h1_e_enCoin_E[8];
  TH1F* h1_e_enCoin_Theta[8];
  TH1F* h1_e_enCoin_Phi[8];
  TH2F* h2_e_enCoin_ThetaPhi[8];
  TH2F* h2_e_enCoin_pTheta[8];
  TH1F* h1_n_enCoin_px[8];
  TH1F* h1_n_enCoin_py[8];
  TH1F* h1_n_enCoin_pz[8];
  TH1F* h1_n_enCoin_p[8];
  TH1F* h1_n_enCoin_E[8];
  TH1F* h1_n_enCoin_Theta[8];
  TH1F* h1_n_enCoin_Phi[8];
  TH2F* h2_n_enCoin_ThetaPhi[8];
  TH2F* h2_n_enCoin_pTheta[8];

  TH1F* h1_piTrue_enCoin_px[8];
  TH1F* h1_piTrue_enCoin_py[8];
  TH1F* h1_piTrue_enCoin_pz[8];
  TH1F* h1_piTrue_enCoin_p[8];
  TH1F* h1_piTrue_enCoin_E[8];
  TH1F* h1_piTrue_enCoin_Theta[8];
  TH1F* h1_piTrue_enCoin_Phi[8];
  TH2F* h2_piTrue_enCoin_ThetaPhi[8];
  TH2F* h2_piTrue_enCoin_pTheta[8];

  TH1F* h1_piTrue_Missed_enCoin_px[8];
  TH1F* h1_piTrue_Missed_enCoin_py[8];
  TH1F* h1_piTrue_Missed_enCoin_pz[8];
  TH1F* h1_piTrue_Missed_enCoin_p[8];
  TH1F* h1_piTrue_Missed_enCoin_E[8];
  TH1F* h1_piTrue_Missed_enCoin_Theta[8];
  TH1F* h1_piTrue_Missed_enCoin_Phi[8];
  TH2F* h2_piTrue_Missed_enCoin_ThetaPhi[8];
  TH2F* h2_piTrue_Missed_enCoin_pTheta[8];

  TString IP_design;

};

#endif // ECCE_DEMP_IR_ANA_H

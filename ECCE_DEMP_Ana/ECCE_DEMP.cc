...
int ECCE_DEMP::Init(PHCompositeNode *topNode)
{
  ...
  h1_nRes_px = new TH1F("nRes_p_{x}", "n #frac{#Delta p_{x}}{Truth p_{x}} Distribution (%); #frac{#Delta p_{x}}{Truth p_{x}} (%)", 100, -5, 5);
  h1_nRes_py = new TH1F("nRes_p_{y}", "n #frac{#Delta p_{y}}{Truth p_{y}} Distribution (%); #frac{#Delta p_{y}}{Truth p_{y}} (%)", 100, -5, 5);
